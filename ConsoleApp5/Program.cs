...
namespace TextGame
{
    class Program
    {
        ...
        {
            /// <summary>
            /// We store the player in here for simplicity, should be stored somewhere else than in the Program entry point ;)
            /// </summary>
            Player player;
            ...
            while (Input.KeyBinds())
            {
                ...
                // let's create a new wallet item so we can give use some money
                var walletItem = new WalletItem(20);
                player.AddItem(walletItem);
